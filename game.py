...
# WOOO THE KEYYYYYYY (Chapter 3)
time.sleep(2)
print("\n-----------------------------")
print("~~~Back at the Desk~~~")
print("-----------------------------")
time.sleep(3)
print(name + " heads back to the office happily. \"You found it, didn't you?\" Taro says, sounding genuinely happy.")
time.sleep(3)
print("\"I did,\" "+ name + " says confidently. \"I'll tell you about it at lunch, but for now, I have to get to work!\"")
time.sleep(3)
print("Taro smirks approvingly. " + name + " passes the desk and heads to the lockers to insert the key.")
time.sleep(3)
print("The locker door easily slides open, and inside is " + name + "'s task folder, just like it's supposed to be!")
time.sleep(3)
print(name + " opens the folder and notices that only one piece of paper is in the folder. The paper says: \"Your assignment: Ensure that each of the creatures in subsection A are content in their habitats.\"")
time.sleep(3)
...
print("-----------------------------")
time.sleep(3)
print("Programmed in Python by Valenciola")
time.sleep(2)
